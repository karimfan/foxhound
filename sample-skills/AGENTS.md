...
- **Root**: `wiki.md` — start here, always
- **Directory summaries**: `{dir}/SUMMARY.md` (one per directory)
- **Root artifacts** (all in ``):
...
**Read `wiki.md` first.** Every task starts here. It gives you:
...
| Question | Read this |
|----------|-----------|
| What files do I need to change for this task? | `recipes.md` |
| Where is a specific file or type defined? | `file-index.md` or `symbol-index.md` |
| What else depends on the code I'm about to change? | `deps-graph.md` |
| How does data flow through the system end-to-end? | `traces.md` |
| Is this area under active development? | `churn.md` |
...
Layer 2 — Directory understanding:
  ...
  4. Read internal/policy/SUMMARY.md
